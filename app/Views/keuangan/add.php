    ...
    <div class="main-wrapper">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Tambah Keuangan</h5>
                        ...
                        <form method="post" action="<?= base_url('keuangan/save'); ?>" class="needs-validation" novalidate>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" class="form-control" placeholder="Nominal" name="nominal" id="nominal" value="<?= old('nominal'); ?>" required>
                                    <div class="invalid-feedback">
                                        Looks good!
                                    </div>
                                </div>
