...
<body class="auth-page sign-in">
    ...
    <div class="connect-container align-content-stretch d-flex flex-wrap">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 text-center mt-3 justify-content-center" style="font-weight: bold; color: #5fd0a5; font-size: 30px; padding: 0; align-items: inherit; ">
                ...
                <div class="col-lg-12">
                    <div class="col-lg-5">
                        <div class="auth-form">
                            <div class="row">
                                <div class="col">
                                    <div class="logo-box"><a href="#" class="logo-text" style="font-size:18px;">Sistem Informasi Pelayanan Penerbitan dan Penggunaan Sertifikat Elektronik Secara Online</a></div>
                                    ...
                                    <form method="post" action="<?= base_url('auth/check_login'); ?>">
                                        ...
                                        <div class="auth-options">
                                            ...
                                            <a href="<?= base_url('auth/register'); ?>" class="forgot-link">Belum punya akun?</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
