      ...
      if (e.length)
        return (
          o.hasClass("open")
            ...
            : (a.length && ($(".accordion-menu > li.open > ul").slideUp(200), a.removeClass("open")), e.slideDown(200), o.addClass("open")),
          !1
        );
    }),
    ...
    $(".horizontal-bar-menu li a").on("click", function () {
      ...
      if (e.length)
        return (
          o.hasClass("open")
            ? (e.slideUp(200), o.removeClass("open"))
            : (a.length && ($(".horizontal-bar-menu > ul > li.open > ul").slideUp(200), a.removeClass("open")), e.slideDown(200), o.addClass("open")),
          !1
        );
    }),
